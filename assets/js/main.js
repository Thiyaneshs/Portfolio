/**
* Template Name: MyResume Inspired Portfolio
* Updated: 2026
...
(function() {
    ...
    const animateProgress = (entries, observer) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          progressBars.forEach((val) => {
            val.style.width = val.getAttribute('aria-valuenow') + '%';
          });
  ...
  /**
   * Portfolio isotope and filter (simplified plain JS)
   */
  ...
  /**
   * Contact Form Submission Handling (Frontend Demo)
   */
